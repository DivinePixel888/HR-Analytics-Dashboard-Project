...
│
├── Documentation/
│   └── Project notes and supporting documents
│
└── README.md
```
...
The dataset used in this project was obtained from Kaggle and is publicly available for learning, analysis, and portfolio development purposes.
